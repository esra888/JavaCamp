...
public class HTLKPSPublicSoap
{
    ...
    public HTLKPSPublicSoap(){}

    public HTLKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public HTLKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        HTLExtendedSoapSerializationEnvelope envelope= new HTLExtendedSoapSerializationEnvelope(HTLExtendedSoapSerializationEnvelope.VER11);
