...
public class HTLExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(HTLDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new HTLStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static HTLDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static HTLDateTimeConverter dateTimeConverter = new HTLStandardDateTimeConverter();

    public HTLExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public HTLExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new HTLMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=HTLHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,HTLExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=HTLHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
